...
eol - program to do something

# SYNOPSIS

**eol** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**eol** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **eol** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**eol** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    eol. See **foo.conf**(5) for further details.
...
**eol** provides some return codes, that can be used in scripts:
...
David Caldwell <David Caldwell <david@porkrind.org>>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 David Caldwell
